          ...
          <div className="flex gap-2 pt-1">
            {[
              ...
              <a
                ...
                className="w-7 h-7 bg-slate-900 hover:bg-indigo-650 border border-slate-850 text-slate-400 hover:text-white rounded-lg flex items-center justify-center transition duration-200"
              >
          ...
          <ul className="space-y-2 text-slate-500">
            {[
              ...
              <li key={link.label}>
                <Link
                  to={link.to}
                  className="hover:text-slate-205 transition duration-150 flex items-center gap-1.5 group"
                >
                  <span className="w-1 h-1 bg-slate-800 group-hover:bg-indigo-500 rounded-full transition duration-150"></span>
                  {link.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-2 text-slate-500">
            <li className="flex items-start gap-2">
              ...
              <span className="leading-snug">Colombo 07, Western Province, Sri Lanka</span>
            </li>
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:support@techmart.lk" className="hover:text-indigo-400 transition">
                support@techmart.lk
              </a>
            </li>
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+9407670999496" className="hover:text-indigo-400 transition">
                +94 076 709 9946
              </a>
            </li>
            <li className="flex items-center gap-2">
