    ...
    <div className="container mx-auto py-16 px-4 max-w-md">
      <div className="bg-white border border-slate-200 shadow-xl rounded-2xl p-8">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-xs text-slate-400 font-semibold mt-1">Register to order tech gadgets</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-bold text-slate-700">
          <div className="space-y-1">
            <label className="block text-slate-500 uppercase tracking-wider text-[10px]">Full Name</label>
            <input 
              type="text" 
              value={fullName}
